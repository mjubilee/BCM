...
public class StatusController {
	...
	public ResponseEntity<List<Status>> retrieveStatusList() {
		setupLocalVariable();
		this.log.info( this.host + " -- " + this.port + " -- trucking-delivery-status-sapi -- retrieveStatusList -- Retrieve all statuses");
	...
	public ResponseEntity<Status> retrieveStatusById(@PathVariable Long id) {		
		setupLocalVariable();
		this.log.info( this.host + " -- " + this.port + " -- trucking-delivery-status-sapi -- retrieveStatusById -- Retrieve specific status");
	...
	public ResponseEntity<Status> insertStatus(@Valid @RequestBody Status status) {	
		setupLocalVariable();
		this.log.info( this.host + " -- " + this.port + " -- trucking-delivery-status-sapi -- insertStatus -- add a new status");
	...
	public ResponseEntity<Status> updateStatus(@Valid @RequestBody Status status) {		
		setupLocalVariable();
		this.log.info( this.host + " -- " + this.port + " -- trucking-delivery-status-sapi -- updateStatus -- update an status");
